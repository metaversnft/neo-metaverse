...
// ROS: Switched to environment variables for security purposes.
// const consumerKey = process.env.DOLBY_CLASSROOM_CONSUMER_KEY;
// const consumerSecret = process.env.DOLBY_CLASSROOM_CONSUMER_SECRET;

const consumerKey = 'DD82S_M1ZmzOuzeiqpPblg==';
const consumerSecret = 'XIY12jRBJuQFkwLwtCMHKPKc_UfCoqHg4QQTYrOCgTA=';
